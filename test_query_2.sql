...
--2.a.--------------------------------------------------------------------------
SELECT location.LOCATION, COUNT(DISTINCT location.ITEM) FROM rpm_future_retail AS location
...
--2.b.--------------------------------------------------------------------------
SELECT zone.ZONE, location.LOCATION, location.ITEM, zone.SELLING_RETAIL, location.SELLING_RETAIL FROM rpm_future_retail AS location
JOIN rpm_zone_location AS temp
ON temp.LOCATION = location.LOCATION
